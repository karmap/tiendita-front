...
const LandingHome = () => (
  <div className="container mx-auto">
    <div className="grid grid-cols-1 gap-0 mt-1">
      <h1 className='font-serif text-gray-700 text-opacity-100 text-3xl m-5 text-center'>
        ¡Hola, bienvenida!
      </h1>
          ...
          <div className="mx-auto m-4">
            <img className="imagen" src="/home-img.jpg" alt="presentacion" />
          </div>
          
          <h1 className='text-gray-700 text-opacity-100 text-3xl m-5 text-center font-serif'>Sistema de Recompensas</h1>
            ...
            <h2 className='font-serif text-gray-700 text-opacity-100 text-3xl m-5 text-center'>¡Inicia tu negocio con nosotros!</h2>
            <Link href="/catalogo">
            <h2 className='font-serif text-gray-700 text-opacity-100 text-3xl m-5 text-center hover:underline focus:underline'>Catálogos disponibles</h2>
            </Link>

          <div className="grid grid-cols-1 gap-0 m-4 text-center mx-auto">
            <img className="imagen" src="/home-ropa.jpg" alt="presentacion" />
          </div>
    </div>
  </div>
);
